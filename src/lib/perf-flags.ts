// Module-level flag the gallery sets while its strip is translating,
// read by hero canvases to skip alternate frames. Stays false on routes
// that don't mount the gallery, so heroes used elsewhere tick at full rate.
