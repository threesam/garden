...
export default async function BennyPage() {
  ...
  return (
    ...
    >
      ...
      <section className="border-t border-zinc-800 py-18 md:py-24">
        <div className="mx-auto max-w-3xl px-6 md:px-9">
          <p className="mb-9 font-mono text-xs uppercase tracking-[0.22em] text-[var(--coin)] md:text-sm">
          ...
          <div className="flex items-center gap-9 md:gap-12">
            <a
              ...
              className="text-zinc-500 transition-colors duration-300 hover:text-[var(--coin)]"
            >
              <svg
